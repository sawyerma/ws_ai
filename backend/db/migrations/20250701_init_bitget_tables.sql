...
CREATE TABLE IF NOT EXISTS coin_settings (
    ...
    -- Versionierung für ReplacingMergeTree
    _version UInt64 DEFAULT toUnixTimestamp64Nano(now64(9))  -- Nanosekunden-Präzision
)
ENGINE = ReplacingMergeTree(_version)
ORDER BY (symbol, market)
PRIMARY KEY (symbol, market)  -- Expliziter Primärschlüssel
...
CREATE TABLE IF NOT EXISTS trades (
    ...
    -- Shard-key für verteilte Systeme
    _shard_key UInt32 DEFAULT cityHash64(trade_id)  -- Besser verteilt
)
